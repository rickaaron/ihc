...
insert  into `t_dat_specialties`(`id_spe`,`f_id_user`,`specialtie`) values (1,1,'asdasdasd');
...
insert  into `t_dat_treatments`(`id_treatment`,`f_id_user`,`f_id_patient`,`f_id_quote`,`symptom`,`treatment`,`status`,`reason`) values (1,11,5,5,' quotequote',' quotequote','deleted','no es segisdjobsd csdichb sldhic'),(2,11,5,5,' asdasdasd',' asdasdasd','deleted',''),(3,11,5,1,' asdasdasd',' asdasdasdasd','active',NULL),(4,11,5,1,'sdfsdfsdf',' sdfsdfsdf','deleted',''),(5,11,5,1,' f_id_quotef_id_quote',' f_id_quotef_id_quote','active',NULL),(6,11,5,1,' change_quotechange_quote',' change_quotechange_quote','active',NULL),(7,11,5,1,' vdfvdfv',' vdfvdfv','deleted',''),(10,11,5,1,' sdfsdffds',' sdfsdffds','deleted',''),(11,11,5,1,' dqwefwefwef',' wfwefwef','deleted',''),(12,11,5,2,' sdfsvsdv',' sdvsvsdv','active',NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_cat_tratments` AS select `user`.`id_user` AS `id_user`,`treatment`.`f_id_patient` AS `id_patient`,`treatment`.`id_treatment` AS `id_treatment`,`treatment`.`symptom` AS `symptom`,`treatment`.`treatment` AS `treatment`,`treatment`.`status` AS `status`,`patient`.`name` AS `name` from ((`t_dat_users` `user` join `t_dat_treatments` `treatment` on((`user`.`id_user` = `treatment`.`f_id_user`))) join `t_dat_patients` `patient` on((`treatment`.`f_id_patient` = `patient`.`id_patient`))) */;
