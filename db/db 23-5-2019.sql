...
insert  into `t_dat_patients`(`id_patient`,`f_id_user`,`name`,`lastname_1`,`lastname_2`,`sex`,`age`,`birthdate`,`civil_status`,`children`,`direction`,`colony`,`cp`,`city`,`telephone`,`office`,`cellphone`,`email`,`record`,`status`,`uuid`) values (16,13,'wefwefwefwef','wefwefwefwef','wefwefwefwef','mujer',8,'2019-05-10','casado',0,'wefwefwefwef','wefwefwefwef','wefwefwefwef','wefwefwefwef','wefwefwefwef','wefwefwefwef','wefwefwefwef','wefwefwefwef@gmial.com','dsfsdfsdv','active','JhAa06AlqX'),(17,13,'Ricardo','Esquivel','Falta la edadFalta la edad','hombre',4,'2019-05-04','soltero',0,'valle de valparaiso 721','Tel.Oficina','67164','Guadalupe','018118930037','435435345','435345345345','r_@daf.com','sfsdfsdfsdf','active','_IuJTCMZ1y');
...
insert  into `t_dat_quotes`(`id_quote`,`f_id_user`,`f_id_patient`,`date`,`hour`,`period`,`min`,`status`,`reason`) values (11,13,17,'2019-05-08',1,'am','00','active',NULL),(12,13,17,'2019-05-08',1,'am','00','active',NULL),(13,13,17,'2019-05-08',1,'am','00','deleted','Otras oblicaciones del dia');
...
insert  into `t_dat_users`(`id_user`,`name`,`lastname_1`,`lastname_2`,`email`,`direction`,`telephone`,`rfc`,`password`) values (13,'asdasdasd','','','ricardoaaron_@hotmail.com','','','','qweqweqwe');
